function login(){
    ...
    if (username.length>0&&password.length>0) {
        myajax("/PsychologicalConsultationPlatform/UserServlet?methodName=login",
            {username: username, password: password,gettype:gettype}, function (msg) {
                var megob = JSON.parse(msg);
                if (megob.msg === "success") {
                    location.href = "/PsychologicalConsultationPlatform/UserServlet?methodName=returnlogin";
